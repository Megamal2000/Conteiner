object EstatMOT: TEstatMOT
  ...
  object JvDBGrid1: TJvDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'TotalR'
        Title.Caption = 'Romaneios'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'TotalNF'
        Title.Caption = 'Notas F'
        Visible = True
      end
      item
        Expanded = False
      ...
      item
        ...
        Title.Caption = 'Nao Entregues'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'FaltaTempo'
        Title.Caption = 'Falta Tempo'
        Visible = True
      end
      item
        Expanded = False
  ...
  object Tab: TJvMemoryData
    ...
    object TabFaltaTempo: TIntegerField
      FieldName = 'FaltaTempo'
      DisplayFormat = '#,##0'
    end
    object TabTotalR: TIntegerField
      FieldName = 'TotalR'
      DisplayFormat = '#,##0'
    end
    object TabMotorista: TStringField
      FieldName = 'Motorista'
      Size = 40
    end
  end
