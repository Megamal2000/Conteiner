object TikDev2: TTikDev2
  Left = 277
  Top = 169
  BorderIcons = [biSystemMenu]
  Caption = 'Administra'#231#227'o de Devolu'#231#245'es - Cliente'
  ClientHeight = 460
  ClientWidth = 615
  Color = clBtnFace
  ...
  object PopupMenu1: TPopupMenu
    ...
    object Recebidopor1: TMenuItem
      Caption = 'Recebido por (TODOS)'
      OnClick = Recebidopor1Click
    end
    object RecebidoporUM1: TMenuItem
      Caption = 'Recebido por (UM)'
      Visible = False
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object RetirardoRelatrio1: TMenuItem
      Caption = 'Retirar do Relat'#243'rio'
      OnClick = RetirardoRelatrio1Click
    end
  end
  object relDev: TppReport
    AutoStop = False
    ...
    Template.FileName = 'F:\XEtrab\FlaydelSofts\Singular\RELS\RecDev.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel2: TppLabel
        ...
        Caption = 'Recibo de Entrega de Devolu'#231#245'es'
