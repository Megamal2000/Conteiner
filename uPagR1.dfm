object PagR1: TPagR1
  ...
  Caption = 'Lista de Pagamentos de Motoristas'
  ClientHeight = 441
  ClientWidth = 659
  Color = clBtnFace
  ...
  object RelPG: TppReport
    ...
    Template.FileName = 'G:\FlaydelSOFTS\Singular\RELS\RelPag1.rtm'
  ...
  object Tab: TJvMemoryData
    ...
    Left = 608
    Top = 296
    object TabidMot: TIntegerField
      FieldName = 'idMot'
    end
    object TabNomeMot: TStringField
      FieldName = 'NomeMot'
      Size = 40
    end
    object TabServ: TCurrencyField
      FieldName = 'Serv'
      DisplayFormat = '#,##0.00'
    end
    object TabCreditos: TCurrencyField
      FieldName = 'Creditos'
      DisplayFormat = '#,##0.00'
    end
    object TabVales: TCurrencyField
      FieldName = 'Vales'
      DisplayFormat = '#,##0.00'
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object CriarLista1: TMenuItem
      Caption = 'Criar Lista'
      OnClick = CriarLista1Click
    end
  end
end
