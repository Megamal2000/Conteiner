object tikDT: TtikDT
  ...
  Caption = 'Relat'#243'rio de Notas Entregues'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dat1: TDateTimePicker
      ...
      Width = 113
      Height = 21
      Date = 41152.935965347220000000
      Format = 'dd/MM/yyyy, ddd '
      Time = 41152.935965347220000000
      TabOrder = 1
      OnChange = dat1Change
    end
    object dat2: TDateTimePicker
      ...
      Width = 121
      Height = 21
      Date = 41152.936148182870000000
      Format = 'dd/MM/yyyy, ddd '
      Time = 41152.936148182870000000
      TabOrder = 2
    end
  ...
  object relTik: TppReport
    ...
    Template.FileName = 'G:\FlaydelSOFTS\Singular\RELS\RelTik.rtm'
    DeviceType = 'Screen'
